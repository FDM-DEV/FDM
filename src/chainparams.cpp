...
/*if(genesis.GetHash() != uint256("0x001"))
        ...
        assert(genesis.hashMerkleRoot == uint256("0x8cc797f607d48adec4224818cdec4424b601f1859193dde47a872a8510235d45"));
         ...
         vSeeds.push_back(CDNSSeedData("138.197.14.77", "138.197.14.77"));             // seed 
         vSeeds.push_back(CDNSSeedData("104.248.25.183", "104.248.25.183"));           // seed2
         vSeeds.push_back(CDNSSeedData("142.93.99.196", "142.93.99.196"));         // seed3
         vSeeds.push_back(CDNSSeedData("165.227.105.10", "165.227.105.10"));         // seed4
         vSeeds.push_back(CDNSSeedData("209.97.153.36", "209.97.153.36"));           // seed5
         vSeeds.push_back(CDNSSeedData("142.93.99.196", "142.93.99.196"));           // seed6
	     vSeeds.push_back(CDNSSeedData("167.99.168.8", "167.99.168.8"));           // seed7
	     vSeeds.push_back(CDNSSeedData("206.189.180.208", "206.189.180.208"));            // seed8
